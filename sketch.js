...
// Moving background
path=createSprite(275,displayHeight/2);
...
function draw() {
  ...
  if(mainCyclist.x > displayWidth/2-100 ){
    ...
    text("Press upArrow to restart",200,300);
...
function obstacle(){
  if (frameCount%60==0){
    obst=createSprite(displayWidth+20,random(10,490),10,10)
...
function obstacle2(){
  if (frameCount%70==0){
    obst2=createSprite(displayWidth+20,random(50,450),10,10)
...
function obstacle3(){
  if (frameCount%80==0){
    obst3=createSprite(displayWidth+20,random(50,450),10,10)
...
function opponent(){
  if (frameCount%60==0){
    opp=createSprite(displayWidth+20,random(0,500),10,10)
...
function opponent2(){
  if (frameCount%60==0){
    opp2=createSprite(displayWidth+20,random(0,500),10,10)
...
function opponent3(){
  if (frameCount%60==0){
    opp3=createSprite(displayWidth+20,random(0,500),10,10)
